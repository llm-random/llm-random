...
from research.nonlinearities.archive.temporary_code.temp_research_bert import (
...
parser.add_argument("--project_name", type=str, default="mpioro/xddd")
...
assert args.ff_mode in [
    "vanilla",
    "bottleneck",
    "inception",
    "multineck",
    "multineck_forced",
], f"ff_mode: {args.ff_mode} must be one of vanilla, bottleneck, inception, multineck, choppedneck"
# constants
...
if args.attention_mode == "vanilla":
    ...
    attention_layer_fun = lambda: research_bert.ThinAttention(
        args.dmodel, args.n_att_heads, thinning_factor=args.attention_thinning_coeff
    )
