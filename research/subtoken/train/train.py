...
from research.subtoken.train.train_utils import (
    SubtokenEmbeddingBlock,
    get_model,
)
from lizrd.text import tokenizers
from research.subtoken.utils.check_args import check_args
from research.subtoken.text.datasets import DataloaderWrapper, get_processed_dataset
from lizrd.train.scheduler import get_scheduler
from research.subtoken.utils.trainer import SubtokenTrainer
from research.subtoken.utils.argparse import introduce_parser_arguments
from research.subtoken.utils.model_utils import (
...
def main(
    ...
    embedding = [m for m in model.modules() if isinstance(m, SubtokenEmbeddingBlock)][0]
    head = model.head
