...
#         token_choice_layer.lin1_weight.data = lin[0].weight.data.transpose(0, 1)
#         token_choice_layer.lin2_weight.data = lin[2].weight.data.transpose(0, 1)

#         # make sure weights act the same
#         input = torch.rand((batch, seql, experts, dm))
