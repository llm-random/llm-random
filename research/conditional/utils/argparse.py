...
def introduce_parser_arguments(
    ...
    parser.add_argument("--distillation_type", type=str, default=None, help="options: [distilgpt]") #dev decide what is the best
    ...
    # parser.add_argument("--projected_att_heads", type=int, required=False) #dev TODO
    # parser.add_argument("--projected_n_layers", type=int, required=False)
