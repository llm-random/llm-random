...
def main(
    ...
    try:
        ...
        if args.fsdp_enabled:
            ...
            fsdp_mixed_precision_ignore_classes = get_mixed_precision_ignored_classes(
                args
            )
            fsdp_modules_to_wrap = get_classes_from_module_names(
                args.fsdp_modules_to_wrap
            )
        else:
        ...
        update_model_fit_gpu_info(
            args.model_fit_gpu_info_database_path,
            model_fit_gpu_info_params,
            "initialized",
        )
        ...
        param_grops, ratios_in_group_order = make_param_groups_and_lr_ratios(
            args, model
        )
