...
class TokenChoiceRouterOld(LoggingLayer):
    def __init__(
        self,
        dmodel: int,
        n_experts: int,
...
class TokenChoiceFFOld(LoggingLayer):
    def __init__(
        self,
        dmodel: int,
        n_experts: int,
        ...
        self.router = TokenChoiceRouterOld(
            dmodel=dmodel,
            n_experts=n_experts,
...
class ExpertReluOld(LoggingLayer):
    def __init__(
        self,
        dmodel: int,
        n_experts: int,
...
class ExpertSwiGLUOld(LoggingLayer):
    def __init__(
        self,
        dmodel: int,
        n_experts: int,
