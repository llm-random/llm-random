...
class GPTMetaPacker(
    ...
    def get_sample(self) -> LLMMetaExample:
        ...
        ids_exp_groups = torch.tensor(take_circular(token_metadata_buffer, sample_start, sample_end))
        one_hot_exp_groups = torch.nn.functional.one_hot(ids_exp_groups, num_classes=N_GROUPS)
