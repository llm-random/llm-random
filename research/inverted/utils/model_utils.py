...
from research.inverted.moe_layers.cont_moe_designs.common_weighted_parameter_matrices import (
    ContinuousMoECommonWeightedParameters,
)
from research.inverted.moe_layers.cont_moe_designs.learnable_temperature_positive import (
    ContinuousMoEAdaTempPositive,
)
from research.inverted.moe_layers.cont_moe_designs.random_grouping import (
    ContinuousMoERandomGroups,
)
from research.inverted.moe_layers.cont_moe_designs.learn_temp_and_common_base import (
    ContinuousMoEFinal,
)
from research.inverted.moe_layers.cont_moe_designs.learnable_temperature import (
    ContinuousMoEAdaTemp,
)
from research.inverted.moe_layers.cont_moe_designs.add_layernorms import (
    ContinuousMoELayernorm,
)
from research.inverted.moe_layers.cont_moe_designs.no_softmax_on_weights import (
    ContinuousMoENosoftmax,
)
from research.inverted.moe_layers.cont_moe_designs.send_result_only_to_top1_token import (
    ContinuousMoETopmerge,
)
from research.inverted.moe_layers.cont_moe_designs.merge_without_weights import (
    ContinuousMoERawmerge,
)
from research.inverted.moe_layers.cont_moe_designs.separate_merge_emit_weights_common_base import (
    ContinuousMoEMergeDifferentlyCommonBase,
)
from research.inverted.moe_layers.cont_moe_designs.separate_merge_emit_weights import (
    ContinuousMoEMergeDifferentlySimple,
)
from research.inverted.moe_layers.cont_moe_designs.separate_weighted_parameter_matrices import (
    ContinuousMoESeparateWeightedParameters,
)
from research.inverted.moe_layers.continuous_moe import (
    ContinuousMoE,
    LegacyContinuousMoE,
)
from research.inverted.moe_layers._expert_choice_old import (
    ExpertChoiceFFOld,
    ExpertGatingOld,
)
from research.inverted.moe_layers.expert_choice import ExpertChoiceFF
from research.inverted.moe_layers._token_choice_old import (
    TokenChoiceFFOld,
    TokenChoiceRouterOld,
    ExpertReluOld,
    ExpertSwiGLUOld,
)
from research.inverted.moe_layers.moe_gating import (
    MoeGating,
    ExpertGating,
    TokenGating,
)
from research.inverted.moe_layers.token_choice import (
    TokenChoiceFF,
)
from research.inverted.moe_layers.expert_types import (
    ExpertFF,
    ExpertGated,
    ExpertLinear,
)
from research.mamba.moe_in_mamba import MambaInProj
from research.inverted.moe_layers.ff_timed import FeedForwardTimed
from research.inverted.moe_layers.expert_double_choice import DoubleChoiceFF
...
def get_ff_layer(args):
    if args.ff_mode == "vanilla":
        ...
        from research.inverted.moe_layers.kernelized import FCKernelized
