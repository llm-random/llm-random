...
def get_args():
    ...
    group.add_argument(
        ...
        type=str,
        required=True,
        choices=['sentencepiece', 'megatron', 'huggingface', 'tabular', "byte-level"],
    ...
    group.add_argument('--delimiter', type=str, default=None, help='delimiter used for tabular tokenizer') #dev
