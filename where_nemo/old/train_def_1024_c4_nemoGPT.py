...
# from nemo.collections.llm.models.language_model.megatron_gpt_model import MegatronGPTModel
...
if __name__ == "__main__":
    ...
    save_pruned_model(save_path="my_my_my_checkpoint_pls", trainer=trainer)
