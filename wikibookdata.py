...
class SentencePairProcessor(object):
    ...
    def tokenize_text(self, sentence_text):
        ...
        return self.tokenizer.convert_tokens_to_ids(self.tokenizer.tokenize(sentence_text))
    ...
    def join_sentence_tokens(self, sentence_tokens1, sentence_tokens2):
        ...
        return [self.cls_id] + sentence_tokens1 + [self.sep_id] + sentence_tokens2 + [self.sep_id]
    ...
    def pad_tokens(self, sentence_tokens):
        ...
        return sentence_tokens + [self.pad_id] * (self.max_total_length - len(sentence_tokens))
