...
- Decoupled Relative Learning Rate Schedules ([implementation](https://github.com/llm-random/llm-random/releases/tag/relative_learning_rates), [arxiv](https://arxiv.org/abs/2507.03526))
- Joint MoE Scaling Laws: Mixture of Experts Can Be Memory Efficient ([arxiv](https://arxiv.org/abs/2502.05172))
- Projected Compression: Trainable Projection for Efficient Transformer Compression ([arxiv](https://arxiv.org/abs/2506.22255))
