...
Example usage (VSCode):
    ...
    2. $ python source/scripts/make_argparse_schema.py research/blanks/argparse.py > research/blanks/schema.json
...
def create_schema(parser: argparse.ArgumentParser) -> dict:
    res = {
        ...
        "properties": {
            ...
            "cuda_visible": {
                "description": "Which gpus can be used (SECRET_CLUSTER4)",
                "type": "string",
            },
            "hf_datasets_cache": {
