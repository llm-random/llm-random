...
class TestYaml(GeneralTestCase):
    def test_multiple(self):
        ...
        """
        path_to_yaml = "lizrd/grid/tests/configs/multiple_yamls.yaml"
    ...
    def test_inherit(self):
        ...
        """
        path_to_yaml = "lizrd/grid/tests/configs/inheritance_yaml.yaml"
        configs, paths_to_all_configs = load_with_inheritance(path_to_yaml)
        assert paths_to_all_configs == [
            "lizrd/grid/tests/configs/inheritance_yaml.yaml",
            "lizrd/grid/tests/configs/inheritance_yaml2.yaml",
        ]
        configs = list(configs)
        for config in configs:
            print(config)
