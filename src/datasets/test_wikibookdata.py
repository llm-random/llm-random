...
import src.datasets.processed_batch
from src.datasets.wikibookdata import get_processed_dataset
from src.support.test_utils import GeneralTestCase, skip_test, heavy_test
import pickle
...
class TestWikibookdata(GeneralTestCase):
    ...
    def test_integration_deprecated(self):
        ...
        isinstance(processed_batch, src.datasets.processed_batch.ProcessedBatch)
    ...
    def test_consistency(self):
        ...
        with open("src/datasets/test_batch.pkl", "rb") as f:
