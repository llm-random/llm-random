...
from src.support.code_versioning import find_git_root, version_code
from src.support.misc import generate_random_string
...
def set_up_permissions(host):
    try:
        with ConnectWithPassphrase(host) as connection:
            path = f"{get_base_directory(connection)}/src/scripts/grid_entrypoint_athena.sh"
...
if __name__ == "__main__":
    ...
    base_dir = rsync_to_remote(args.host, working_dir + "/src")
