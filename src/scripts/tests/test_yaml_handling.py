...
from src.support.misc import load_with_inheritance
...
class TestYaml(GeneralTestCase):
    def test_multiple(self):
        ...
        """
        path_to_yaml = "src/scripts/tests/configs/multiple_yamls.yaml"
    ...
    def test_inherit(self):
        ...
        """
        path_to_yaml = "src/scripts/tests/configs/inheritance_yaml.yaml"
        configs, paths_to_all_configs = load_with_inheritance(path_to_yaml)
        assert set(paths_to_all_configs) == {
            "src/scripts/tests/configs/inheritance_yaml.yaml",
            "src/scripts/tests/configs/inheritance_yaml2.yaml",
        }
        configs = list(configs)
        for config in configs:
            print(config)
